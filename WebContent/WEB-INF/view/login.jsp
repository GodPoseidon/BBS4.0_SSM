	...
	<div class="center">
		<div >
			<form action="login" method="post" >
				<div class="left">
					<span>邮箱：</span> <input type="text" name="email" id="email" value="${requestScope.email}"></div>
					<div class="left">
					<span>密码：</span> <input type="password" name="password" id="password">
				</div>
				<div class="left">
					<span>验证码：</span> <input type="text" name="verify" style="width: 100PX;" id="verify"><img alt="" src="verifycode" id="verifycode">
